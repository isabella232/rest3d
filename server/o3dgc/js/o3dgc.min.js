...
O3DGC_SC3DMC_CIRCULAR_DIFFERENTIAL_PREDICTION:4,O3DGC_SC3DMC_PARALLELOGRAM_PREDICTION:5,O3DGC_SC3DMC_SURF_NORMALS_PREDICTION:6,O3DGC_SC3DMC_ENHANCED_DIFFERENTIAL_PREDICTION:7,O3DGC_SC3DMC_ENHANCED_PARALLELOGRAM_PREDICTION:8,O3DGC_SC3DMC_ENCODE_MODE_QBCR:0,O3DGC_SC3DMC_ENCODE_MODE_SVA:1,O3DGC_SC3DMC_ENCODE_MODE_TFAN:2,O3DGC_DYNAMIC_VECTOR_ENCODE_MODE_LIFT:0,O3DGC_MIN_NEIGHBORS_SIZE:128,O3DGC_MIN_NUM_NEIGHBORS_SIZE:16,O3DGC_TFANS_MIN_SIZE_ALLOCATED_VERTICES_BUFFER:128,O3DGC_TFANS_MIN_SIZE_TFAN_SIZE_BUFFER:8,
O3DGC_DEFAULT_VECTOR_SIZE:32};b.O3DGC_IFS_FLOAT_ATTRIBUTE_TYPE_UNKOWN=0;b.O3DGC_IFS_FLOAT_ATTRIBUTE_TYPE_POSITION=1;b.O3DGC_IFS_FLOAT_ATTRIBUTE_TYPE_NORMAL=2;b.O3DGC_IFS_FLOAT_ATTRIBUTE_TYPE_COLOR=3;b.O3DGC_IFS_FLOAT_ATTRIBUTE_TYPE_TEXCOORD=4;b.O3DGC_IFS_FLOAT_ATTRIBUTE_TYPE_WEIGHT=5;b.O3DGC_IFS_INT_ATTRIBUTE_TYPE_UNKOWN=0;b.O3DGC_IFS_INT_ATTRIBUTE_TYPE_INDEX=1;b.O3DGC_IFS_INT_ATTRIBUTE_TYPE_JOINT_ID=2;b.O3DGC_IFS_INT_ATTRIBUTE_TYPE_INDEX_BUFFER_ID=3;b.O3DGC_OK=0;b.O3DGC_ERROR_BUFFER_FULL=1;b.O3DGC_ERROR_CORRUPTED_STREAM=
5;b.O3DGC_ERROR_NON_SUPPORTED_FEATURE=6;b.O3DGC_ERROR_AC=7;b.SC3DMCStats=function(){this.m_timeCoordIndex=this.m_timeNormal=this.m_timeCoord=0;this.m_timeFloatAttribute=new Float32Array(g.O3DGC_SC3DMC_MAX_NUM_FLOAT_ATTRIBUTES);this.m_timeIntAttribute=new Float32Array(g.O3DGC_SC3DMC_MAX_NUM_INT_ATTRIBUTES);this.m_streamSizeCoordIndex=this.m_streamSizeNormal=this.m_streamSizeCoord=this.m_timeReorder=0;this.m_streamSizeFloatAttribute=new Uint32Array(g.O3DGC_SC3DMC_MAX_NUM_FLOAT_ATTRIBUTES);this.m_streamSizeIntAttribute=
new Uint32Array(g.O3DGC_SC3DMC_MAX_NUM_INT_ATTRIBUTES)};b.SC3DMCTriplet=function(a,d,b){this.m_a=a;this.m_b=d;this.m_c=b};b.SC3DMCTriplet.prototype.Less=function(a){return this.m_c!==a.m_c?this.m_c<a.m_c:this.m_b!==a.m_b?this.m_b<a.m_b:this.m_a<a.m_a};b.SC3DMCTriplet.prototype.Equal=function(a){return this.m_c===a.m_c&&this.m_b===a.m_b&&this.m_a===a.m_a};"undefined"===typeof window.performance&&(window.performance={});window.performance.now||(g.nowOffset=Date.now(),performance.timing&&performance.timing.navigationStart&&
(g.nowOffset=performance.timing.navigationStart),window.performance.now=function(){return Date.now()-g.nowOffset});b.Timer=function(){this.m_end=this.m_start=0};b.Timer.prototype.Tic=function(){this.m_start=window.performance.now()};b.Timer.prototype.Toc=function(){this.m_end=window.performance.now()};b.Timer.prototype.GetElapsedTime=function(){return this.m_end-this.m_start};b.Vec3=function(a,d,b){this.m_x=a;this.m_y=d;this.m_z=b};b.Vec3.prototype.Set=function(a,d,b){this.m_x=a;this.m_y=d;this.m_z=
b};b.Vec3.prototype.Sub=function(a,d){this.m_x=a.m_x-d.m_x;this.m_y=a.m_y-d.m_y;this.m_z=a.m_z-d.m_z};b.Vec3.prototype.Add=function(a,d){this.m_x=a.m_x+d.m_x;this.m_y=a.m_y+d.m_y;this.m_z=a.m_z+d.m_z};b.Vec3.prototype.SelfAdd=function(a){this.m_x+=a.m_x;this.m_y+=a.m_y;this.m_z+=a.m_z};b.Vec3.prototype.Cross=function(a,d){this.m_x=a.m_y*d.m_z-a.m_z*d.m_y;this.m_y=a.m_z*d.m_x-a.m_x*d.m_z;this.m_z=a.m_x*d.m_y-a.m_y*d.m_x};b.Vec3.prototype.GetNorm=function(){return Math.sqrt(this.m_x*this.m_x+this.m_y*
this.m_y+this.m_z*this.m_z)};g.CubeToSphere={0:function(a,d){d.m_x=a.m_x;d.m_y=a.m_y;d.m_z=Math.sqrt(Math.max(0,1-d.m_x*d.m_x-d.m_y*d.m_y))},1:function(a,d){d.m_x=-a.m_x;d.m_y=-a.m_y;d.m_z=-Math.sqrt(Math.max(0,1-d.m_x*d.m_x-d.m_y*d.m_y))},2:function(a,d){d.m_z=a.m_x;d.m_x=a.m_y;d.m_y=Math.sqrt(Math.max(0,1-d.m_x*d.m_x-d.m_z*d.m_z))},3:function(a,d){d.m_z=-a.m_x;d.m_x=-a.m_y;d.m_y=-Math.sqrt(Math.max(0,1-d.m_x*d.m_x-d.m_z*d.m_z))},4:function(a,d){d.m_y=a.m_x;d.m_z=a.m_y;d.m_x=Math.sqrt(Math.max(0,
1-d.m_y*d.m_y-d.m_z*d.m_z))},5:function(a,d){d.m_y=-a.m_x;d.m_z=-a.m_y;d.m_x=-Math.sqrt(Math.max(0,1-d.m_y*d.m_y-d.m_z*d.m_z))}};b.Iterator=function(){this.m_count=0};b.NumberRef=function(){this.m_value=0};b.BinaryStream=function(a){var d;var b;b=new ArrayBuffer(4);d=new Uint32Array(b);b=new Uint8Array(b);d[0]=1;d=1===b[0]?g.O3DGC_LITTLE_ENDIAN:g.O3DGC_BIG_ENDIAN;this.m_endianness=d;this.m_buffer=a;this.m_stream=new Uint8Array(this.m_buffer);this.m_localBuffer=new ArrayBuffer(4);this.m_localBufferViewUChar8=
new Uint8Array(this.m_localBuffer);this.m_localBufferViewFloat32=new Float32Array(this.m_localBuffer);this.m_localBufferViewUInt32=new Uint32Array(this.m_localBuffer)};b.BinaryStream.prototype.ReadFloat32Bin=function(a){this.m_endianness===g.O3DGC_BIG_ENDIAN?(this.m_localBufferViewUChar8[3]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[2]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[1]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[0]=this.m_stream[a.m_count++]):(this.m_localBufferViewUChar8[0]=
this.m_stream[a.m_count++],this.m_localBufferViewUChar8[1]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[2]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[3]=this.m_stream[a.m_count++]);return this.m_localBufferViewFloat32[0]};b.BinaryStream.prototype.ReadUInt32Bin=function(a){this.m_endianness===g.O3DGC_BIG_ENDIAN?(this.m_localBufferViewUChar8[3]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[2]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[1]=this.m_stream[a.m_count++],
this.m_localBufferViewUChar8[0]=this.m_stream[a.m_count++]):(this.m_localBufferViewUChar8[0]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[1]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[2]=this.m_stream[a.m_count++],this.m_localBufferViewUChar8[3]=this.m_stream[a.m_count++]);return this.m_localBufferViewUInt32[0]};b.BinaryStream.prototype.ReadUChar8Bin=function(a){return this.m_stream[a.m_count++]};b.BinaryStream.prototype.ReadUInt32ASCII=function(a){var b,c,e;for(e=c=b=0;e<
g.O3DGC_BINARY_STREAM_NUM_SYMBOLS_UINT32;++e)b+=this.m_stream[a.m_count++]<<c>>>0,c+=g.O3DGC_BINARY_STREAM_BITS_PER_SYMBOL0;return b};b.BinaryStream.prototype.ReadFloat32ASCII=function(a){a=this.ReadUInt32ASCII(a);this.m_endianness===g.O3DGC_BIG_ENDIAN?(this.m_localBufferViewUChar8[3]=a&g.O3DGC_MAX_UCHAR8,a>>>=8,this.m_localBufferViewUChar8[2]=a&g.O3DGC_MAX_UCHAR8,a>>>=8,this.m_localBufferViewUChar8[1]=a&g.O3DGC_MAX_UCHAR8,this.m_localBufferViewUChar8[0]=a>>>8&g.O3DGC_MAX_UCHAR8):(this.m_localBufferViewUChar8[0]=
a&g.O3DGC_MAX_UCHAR8,a>>>=8,this.m_localBufferViewUChar8[1]=a&g.O3DGC_MAX_UCHAR8,a>>>=8,this.m_localBufferViewUChar8[2]=a&g.O3DGC_MAX_UCHAR8,a>>>=8,this.m_localBufferViewUChar8[3]=a&g.O3DGC_MAX_UCHAR8);return this.m_localBufferViewFloat32[0]};b.BinaryStream.prototype.ReadIntASCII=function(a){return I(this.ReadUIntASCII(a))};b.BinaryStream.prototype.ReadUIntASCII=function(a){var b,c,e;e=this.m_stream[a.m_count++];if(e===g.O3DGC_BINARY_STREAM_MAX_SYMBOL0){b=0;do c=this.m_stream[a.m_count++],e+=c>>>
1<<b>>>0,b+=g.O3DGC_BINARY_STREAM_BITS_PER_SYMBOL1;while(c&1)}return e};b.BinaryStream.prototype.ReadUCharASCII=function(a){return this.m_stream[a.m_count++]};b.BinaryStream.prototype.ReadFloat32=function(a,b){return b===g.O3DGC_STREAM_TYPE_ASCII?this.ReadFloat32ASCII(a):this.ReadFloat32Bin(a)};b.BinaryStream.prototype.ReadUInt32=function(a,b){return b===g.O3DGC_STREAM_TYPE_ASCII?this.ReadUInt32ASCII(a):this.ReadUInt32Bin(a)};b.BinaryStream.prototype.ReadUChar=function(a,b){return b===g.O3DGC_STREAM_TYPE_ASCII?
this.ReadUCharASCII(a):this.ReadUChar8Bin(a)};b.BinaryStream.prototype.GetBuffer=function(a,b){return new Uint8Array(this.m_buffer,a.m_count,b)};g.O3DGC_AC_MIN_LENGTH=16777216;g.O3DGC_AC_MAX_LENGTH=4294967295;g.O3DGC_AC_BM_LENGTH_SHIFT=13;g.O3DGC_AC_BM_MAX_COUNT=1<<g.O3DGC_AC_BM_LENGTH_SHIFT>>>0;g.O3DGC_AC_DM_LENGTH_SHIFT=15;g.O3DGC_AC_DM_MAX_COUNT=1<<g.O3DGC_AC_DM_LENGTH_SHIFT>>>0;b.StaticBitModel=function(){this.m_bit0Prob=1<<g.O3DGC_AC_BM_LENGTH_SHIFT-1>>>0};b.StaticBitModel.prototype.SetProbability=
function(a){this.m_bit0Prob=Math.floor(a*(1<<g.O3DGC_AC_BM_LENGTH_SHIFT>>>0))};b.AdaptiveBitModel=function(){this.m_bitsUntilUpdate=this.m_updateCycle=4;this.m_bit0Prob=1<<g.O3DGC_AC_BM_LENGTH_SHIFT-1>>>0;this.m_bit0Count=1;this.m_bitCount=2};b.AdaptiveBitModel.prototype.Reset=function(){this.m_bitsUntilUpdate=this.m_updateCycle=4;this.m_bit0Prob=1<<g.O3DGC_AC_BM_LENGTH_SHIFT-1>>>0;this.m_bit0Count=1;this.m_bitCount=2};b.AdaptiveBitModel.prototype.Update=function(){(this.m_bitCount+=this.m_updateCycle)>
g.O3DGC_AC_BM_MAX_COUNT&&(this.m_bitCount=this.m_bitCount+1>>>1,this.m_bit0Count=this.m_bit0Count+1>>>1,this.m_bit0Count===this.m_bitCount&&++this.m_bitCount);this.m_bit0Prob=this.m_bit0Count*Math.floor(2147483648/this.m_bitCount)>>>31-g.O3DGC_AC_BM_LENGTH_SHIFT;this.m_updateCycle=5*this.m_updateCycle>>>2;64<this.m_updateCycle&&(this.m_updateCycle=64);this.m_bitsUntilUpdate=this.m_updateCycle};b.AdaptiveDataModel=function(){this.m_buffer={};this.m_distribution={};this.m_symbolCount={};this.m_decoderTable=
{};this.m_tableShift=this.m_tableSize=this.m_lastSymbol=this.m_dataSymbols=this.m_symbolsUntilUpdate=this.m_updateCycle=this.m_totalCount=0};b.AdaptiveDataModel.prototype.Update=function(){var a,b,c,e,f;if((this.m_totalCount+=this.m_updateCycle)>g.O3DGC_AC_DM_MAX_COUNT)for(a=this.m_totalCount=0;a<this.m_dataSymbols;++a)this.m_totalCount+=this.m_symbolCount[a]=this.m_symbolCount[a]+1>>>1;b=a=0;c=Math.floor(2147483648/this.m_totalCount);if(0===this.m_tableSize)for(e=0;e<this.m_dataSymbols;++e)this.m_distribution[e]=
c*a>>>31-g.O3DGC_AC_DM_LENGTH_SHIFT,a+=this.m_symbolCount[e];else{for(e=0;e<this.m_dataSymbols;++e)for(this.m_distribution[e]=c*a>>>31-g.O3DGC_AC_DM_LENGTH_SHIFT,a+=this.m_symbolCount[e],f=this.m_distribution[e]>>>this.m_tableShift;b<f;)this.m_decoderTable[++b]=e-1;for(this.m_decoderTable[0]=0;b<=this.m_tableSize;)this.m_decoderTable[++b]=this.m_dataSymbols-1}this.m_updateCycle=5*this.m_updateCycle>>>2;a=this.m_dataSymbols+6<<3>>>0;this.m_updateCycle>a&&(this.m_updateCycle=a);this.m_symbolsUntilUpdate=
this.m_updateCycle};b.AdaptiveDataModel.prototype.Reset=function(){var a;if(0!==this.m_dataSymbols){this.m_totalCount=0;this.m_updateCycle=this.m_dataSymbols;for(a=0;a<this.m_dataSymbols;++a)this.m_symbolCount[a]=1;this.Update();this.m_symbolsUntilUpdate=this.m_updateCycle=this.m_dataSymbols+6>>>1}};b.AdaptiveDataModel.prototype.SetAlphabet=function(a){if(2>a||2048<a)return Console.log("invalid number of data symbols"),b.O3DGC_ERROR_AC;if(this.m_dataSymbols!==a)if(this.m_dataSymbols=a,this.m_lastSymbol=
this.m_dataSymbols-1,16<this.m_dataSymbols){for(a=3;this.m_dataSymbols>1<<a+2>>>0;)++a;this.m_tableSize=1<<a>>>0;this.m_tableShift=g.O3DGC_AC_DM_LENGTH_SHIFT-a;this.m_buffer=new ArrayBuffer(4*(2*this.m_dataSymbols+this.m_tableSize+2));this.m_distribution=new Uint32Array(this.m_buffer,0,this.m_dataSymbols);this.m_symbolCount=new Uint32Array(this.m_buffer,4*this.m_dataSymbols,this.m_dataSymbols);this.m_decoderTable=new Uint32Array(this.m_buffer,8*this.m_dataSymbols,this.m_tableSize+2)}else this.m_tableSize=
this.m_tableShift=0,this.m_buffer=new ArrayBuffer(8*this.m_dataSymbols),this.m_distribution=new Uint32Array(this.m_buffer,0,this.m_dataSymbols),this.m_symbolCount=new Uint32Array(this.m_buffer,4*this.m_dataSymbols,this.m_dataSymbols),this.m_decoderTable={};this.Reset();return b.O3DGC_OK};b.ArithmeticDecoder=function(){this.m_codeBuffer={};this.m_mode=this.m_bufferSize=this.m_length=this.m_value=this.m_base=this.m_acShift=0};b.ArithmeticDecoder.prototype.SetBuffer=function(a,d){if(0===a)return Console.log("invalid codec buffer size"),
b.O3DGC_ERROR_AC;if(0!==this.m_mode)return Console.log("cannot set buffer while encoding or decoding"),b.O3DGC_ERROR_AC;this.m_bufferSize=a;this.m_codeBuffer=d};b.ArithmeticDecoder.prototype.StartDecoder=function(){if(0!==this.m_mode)return Console.log("cannot start decoder"),b.O3DGC_ERROR_AC;if(0===this.m_bufferSize)return Console.log("no code buffer set"),b.O3DGC_ERROR_AC;this.m_mode=2;this.m_length=g.O3DGC_AC_MAX_LENGTH;this.m_acShift=3;this.m_value=(this.m_codeBuffer[0]<<24|this.m_codeBuffer[1]<<
16|this.m_codeBuffer[2]<<8|this.m_codeBuffer[3])>>>0};b.ArithmeticDecoder.prototype.StopDecoder=function(){if(2!==this.m_mode)return Console.log("invalid to stop decoder"),b.O3DGC_ERROR_AC;this.m_mode=0};b.ArithmeticDecoder.prototype.GetBit=function(){this.m_length>>>=1;var a=this.m_value>=this.m_length;a&&(this.m_value-=this.m_length);this.m_length<g.O3DGC_AC_MIN_LENGTH&&this.RenormDecInterval();return a};b.ArithmeticDecoder.prototype.GetBits=function(a){a=Math.floor(this.m_value/(this.m_length>>>=
a));this.m_value-=this.m_length*a;this.m_length<g.O3DGC_AC_MIN_LENGTH&&this.RenormDecInterval();return a};b.ArithmeticDecoder.prototype.DecodeStaticBitModel=function(a){var b;a=a.m_bit0Prob*(this.m_length>>>g.O3DGC_AC_BM_LENGTH_SHIFT);(b=this.m_value>=a)?(this.m_value-=a,this.m_length-=a):this.m_length=a;this.m_length<g.O3DGC_AC_MIN_LENGTH&&this.RenormDecInterval();return b};b.ArithmeticDecoder.prototype.DecodeAdaptiveBitModel=function(a){var b,c;b=a.m_bit0Prob*(this.m_length>>>g.O3DGC_AC_BM_LENGTH_SHIFT);
(c=this.m_value>=b)?(this.m_value-=b,this.m_length-=b):(this.m_length=b,++a.m_bit0Count);this.m_length<g.O3DGC_AC_MIN_LENGTH&&this.RenormDecInterval();0===--a.m_bitsUntilUpdate&&a.Update();return c};b.ArithmeticDecoder.prototype.DecodeAdaptiveDataModel=function(a){var b,c,e,f,s,m;f=this.m_length;if(0<a.m_tableSize){e=Math.floor(this.m_value/(this.m_length>>>=g.O3DGC_AC_DM_LENGTH_SHIFT));b=e>>>a.m_tableShift;c=a.m_decoderTable[b];for(b=a.m_decoderTable[b+1]+1;b>c+1;)m=c+b>>>1,a.m_distribution[m]>e?
b=m:c=m;e=a.m_distribution[c]*this.m_length;c!==a.m_lastSymbol&&(f=a.m_distribution[c+1]*this.m_length)}else{e=c=0;this.m_length>>>=g.O3DGC_AC_DM_LENGTH_SHIFT;m=(b=a.m_dataSymbols)>>>1;do s=this.m_length*a.m_distribution[m],s>this.m_value?(b=m,f=s):(c=m,e=s);while((m=c+b>>>1)!==c)}this.m_value-=e;this.m_length=f-e;this.m_length<g.O3DGC_AC_MIN_LENGTH&&this.RenormDecInterval();++a.m_symbolCount[c];0===--a.m_symbolsUntilUpdate&&a.Update(!1);return c};b.ArithmeticDecoder.prototype.ExpGolombDecode=function(a,
b,c){var e,f,g;f=e=0;do if(g=this.DecodeAdaptiveBitModel(c))e+=1<<a>>>0,a++;while(g);for(;a--;)this.DecodeStaticBitModel(b)&&(f=(f|1<<a)>>>0);return e+f};b.ArithmeticDecoder.prototype.RenormDecInterval=function(){do this.m_value=(this.m_value<<8|this.m_codeBuffer[++this.m_acShift])>>>0,this.m_length=this.m_length<<8>>>0;while(this.m_length<g.O3DGC_AC_MIN_LENGTH)};b.ArithmeticDecoder.prototype.DecodeIntACEGC=function(a,b,c,e,f){a=this.DecodeAdaptiveDataModel(a);a===f&&(a+=this.ExpGolombDecode(e,b,
c));return I(a)};b.ArithmeticDecoder.prototype.DecodeUIntACEGC=function(a,b,c,e,f){a=this.DecodeAdaptiveDataModel(a);a===f&&(a+=this.ExpGolombDecode(e,b,c));return a};b.FIFO=function(){this.m_data={};this.m_end=this.m_start=this.m_size=this.m_allocated=0};b.FIFO.prototype.Clear=function(){this.m_start=this.m_end=this.m_size=0};b.FIFO.prototype.GetAllocatedSize=function(){return this.m_allocated};b.FIFO.prototype.GetSize=function(){return this.m_size};b.FIFO.prototype.Allocate=function(a){a>this.m_allocated&&
(this.m_allocated=a,this.m_data=new Int32Array(this.m_allocated));this.Clear();return b.O3DGC_OK};b.FIFO.prototype.PopFirst=function(){--this.m_size;var a=this.m_start++;this.m_start===this.m_allocated&&(this.m_end=0);return this.m_data[a]};b.FIFO.prototype.PushBack=function(a){--this.m_size;this.m_data[this.m_end]=a;++this.m_size;++this.m_end;this.m_end===this.m_allocated&&(this.m_end=0)};b.IndexedFaceSet=function(){this.m_numIntAttributes=this.m_numFloatAttributes=this.m_nNormal=this.m_nCoord=this.m_nCoordIndex=
0;this.m_creaseAngle=30;this.m_isTriangularMesh=this.m_convex=this.m_solid=this.m_ccw=!0;this.m_coordMin=new Float32Array(3);this.m_coordMax=new Float32Array(3);this.m_normalMin=new Float32Array(3);this.m_normalMax=new Float32Array(3);this.m_nFloatAttribute=new Uint32Array(g.O3DGC_SC3DMC_MAX_NUM_FLOAT_ATTRIBUTES);this.m_nIntAttribute=new Uint32Array(g.O3DGC_SC3DMC_MAX_NUM_INT_ATTRIBUTES);this.m_dimFloatAttribute=new Uint32Array(g.O3DGC_SC3DMC_MAX_NUM_FLOAT_ATTRIBUTES);this.m_dimIntAttribute=new Uint32Array(g.O3DGC_SC3DMC_MAX_NUM_INT_ATTRIBUTES);
...
b.IndexedFaceSet.prototype.GetNormalMaxArray=function(){return this.m_normalMax};b.IndexedFaceSet.prototype.GetFloatAttributeMinArray=function(a){return new Float32Array(this.m_minFloatAttributeBuffer,a*g.O3DGC_SC3DMC_MAX_DIM_ATTRIBUTES*4,this.GetFloatAttributeDim(a))};b.IndexedFaceSet.prototype.GetFloatAttributeMaxArray=function(a){return new Float32Array(this.m_maxFloatAttributeBuffer,a*g.O3DGC_SC3DMC_MAX_DIM_ATTRIBUTES*4,this.GetFloatAttributeDim(a))};b.IndexedFaceSet.prototype.GetFloatAttributeDim=
...
x=v.m_neighbors;f=f.GetCoordIndex();E=p.m_count;h=m.ReadUInt32(p,q);A=m.ReadUChar(p,q);q=A>>>4&15;s.m_value=A&15;h-=p.m_count-E;E=new b.Iterator;E.m_count=p.m_count+h;new b.SC3DMCTriplet(-1,-1,-1);if(q!==g.O3DGC_SC3DMC_BINARIZATION_AC_EGC)return b.O3DGC_ERROR_CORRUPTED_STREAM;m=m.GetBuffer(p,h);p.m_count+=h;w.SetBuffer(h,m);w.StartDecoder();q=w.ExpGolombDecode(0,t,z);A=w.ExpGolombDecode(0,t,z);D=new b.AdaptiveDataModel;D.SetAlphabet(A+2);B=this.m_neighbors;C=new b.NumberRef;h=s.m_value!==g.O3DGC_SC3DMC_NO_PREDICTION;
...
function(a,d,c,e,f,s,m){var l,h,k,n,p,q,w,t,z,r,v,x;n=this.m_iterator;l=this.m_streamType;q=this.m_triangleListDecoder.GetVertexToTriangle();w=q.m_neighbors;f=f.GetCoordIndex();t=n.m_count;k=m.ReadUInt32(n,l);z=m.ReadUChar(n,l);r=z>>>4&15;s.m_value=z&15;k-=n.m_count-t;t=new b.Iterator;t.m_count=n.m_count+k;new b.SC3DMCTriplet(-1,-1,-1);if(r!==g.O3DGC_SC3DMC_BINARIZATION_ASCII)return b.O3DGC_ERROR_CORRUPTED_STREAM;m.ReadUInt32(t,l);r=this.m_neighbors;z=new b.NumberRef;k=s.m_value!==g.O3DGC_SC3DMC_NO_PREDICTION;
...
l,h,k){var n,p,q,w,t,z,r,v,x,E,A,D,B,C,y,F,u,M,H,L,N,J,G;D=this.m_iterator;t=this.m_orientation;B=this.m_streamType;y=new b.ArithmeticDecoder;F=new b.StaticBitModel;u=new b.AdaptiveBitModel;M=new b.AdaptiveDataModel;w=g.O3DGC_SC3DMC_MAX_PREDICTION_NEIGHBORS;M.SetAlphabet(w+1);H=this.m_triangleListDecoder.GetVertexToTriangle();L=H.m_neighbors;N=l.GetCoordIndex();z=d*c;J=D.m_count;G=k.ReadUInt32(D,B);v=k.ReadUChar(D,B);B=v>>>4&15;h.m_value=v&15;G-=D.m_count-J;J=new b.Iterator;J.m_count=D.m_count+G;
if(B!==g.O3DGC_SC3DMC_BINARIZATION_AC_EGC)return b.O3DGC_ERROR_CORRUPTED_STREAM;k=k.GetBuffer(D,G);D.m_count+=G;y.SetBuffer(G,k);y.StartDecoder();G=y.ExpGolombDecode(0,F,u);k=y.ExpGolombDecode(0,F,u);B=new b.AdaptiveDataModel;B.SetAlphabet(k+2);if(h.m_value===g.O3DGC_SC3DMC_SURF_NORMALS_PREDICTION){this.m_orientationSize<z&&(this.m_orientationSize=z,t=this.m_orientation=new Int8Array(this.m_orientationSize));c=new b.AdaptiveDataModel;c.SetAlphabet(12);for(r=0;r<d;++r)t[r]=I(y.DecodeAdaptiveDataModel(c));
this.ProcessNormals(l);c=2}this.m_quantFloatArraySize<z&&(this.m_quantFloatArraySize=z,this.m_quantFloatArray=new Int32Array(this.m_quantFloatArraySize));v=this.m_quantFloatArray;x=this.m_neighbors;E=new b.NumberRef;t=h.m_value!==g.O3DGC_SC3DMC_NO_PREDICTION;z=h.m_value===g.O3DGC_SC3DMC_ENHANCED_PARALLELOGRAM_PREDICTION;for(A=0;A<d;++A){E.m_value=0;l=A*e;if(0<H.GetNumNeighbors(A)&&t){q=H.Begin(A);n=H.End(A);if(z)for(p=q;p<n;++p){r=L[p];if(0>r)break;P(N,r,A,E,x,H,L)}if(E.m_value<w)for(p=q;p<n;++p){r=
L[p];if(0>r)break;K(N,r,A,E,x)}}if(1<E.m_value)if(r=x[y.DecodeAdaptiveDataModel(M)],q=r.m_c*e,0>q)for(p=r.m_b*e,n=r.m_a*e,q=-q-e,r=0;r<c;++r)for(r=0;r<c;++r)C=y.DecodeIntACEGC(B,F,u,G,k),v[l+r]=C+v[n+r]+v[p+r]-v[q+r];else for(r=0;r<c;++r)for(r=0;r<c;++r)C=y.DecodeIntACEGC(B,F,u,G,k),v[l+r]=C+v[q+r];else if(0<A&&t)for(r=0;r<c;++r)C=y.DecodeIntACEGC(B,F,u,G,k),v[l+r]=C+v[(A-1)*e+r];else for(r=0;r<c;++r)C=y.DecodeUIntACEGC(B,F,u,G,k),v[l+r]=C}D.m_count=J.m_count;this.IQuantize(a,d,c,e,f,s,m,h);return b.O3DGC_OK};
b.SC3DMCDecoder.prototype.DecodeFloatArrayASCII=function(a,d,c,e,f,s,m,l,h,k){var n,p,q,w,t,z,r,v,x,E,A,D,B,C,y,F,u;w=g.O3DGC_SC3DMC_MAX_PREDICTION_NEIGHBORS;r=this.m_iterator;t=this.m_orientation;v=this.m_streamType;E=this.m_triangleListDecoder.GetVertexToTriangle();A=E.m_neighbors;D=l.GetCoordIndex();z=d*c;B=r.m_count;C=k.ReadUInt32(r,v);y=k.ReadUChar(r,v);F=y>>>4&15;h.m_value=y&15;C-=r.m_count-B;B=new b.Iterator;B.m_count=r.m_count+C;if(F!==g.O3DGC_SC3DMC_BINARIZATION_ASCII)return b.O3DGC_ERROR_CORRUPTED_STREAM;
k.ReadUInt32(B,v);if(h.m_value===g.O3DGC_SC3DMC_SURF_NORMALS_PREDICTION){this.m_orientationSize<d&&(this.m_orientationSize=d,t=this.m_orientation=new Int8Array(this.m_orientationSize));for(u=0;u<d;++u)t[u]=k.ReadIntASCII(r);this.ProcessNormals(l);c=2}this.m_quantFloatArraySize<z&&(this.m_quantFloatArraySize=z,this.m_quantFloatArray=new Int32Array(this.m_quantFloatArraySize));v=this.m_quantFloatArray;C=this.m_neighbors;F=new b.NumberRef;t=h.m_value!==g.O3DGC_SC3DMC_NO_PREDICTION;z=h.m_value===g.O3DGC_SC3DMC_ENHANCED_PARALLELOGRAM_PREDICTION;
